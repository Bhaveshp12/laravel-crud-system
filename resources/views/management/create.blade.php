        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-#212529 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @endif
                    ...
                    <div class="card-body">
                        <form action="{{url('management/create')}}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <lable>CarName</lable>
                                <input type="text" name="carname" class="form-control" value="{{old('carname')}}"/>
    
                                @error('carname') <span class="text-danger">{{$message}}</span> @enderror  
                            </div>
                            <div class="mb-3">
                                <lable>CarCompany</lable>
                                <input type="text" name="carcompany" class="form-control" value="{{old('carcompany')}}"/>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="carmodel" class="form-control" value="{{old('carmodel')}}"/>
